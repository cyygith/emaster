    ...
    <div id="itemlist-panel" class="itemlist-panel">
                ...
                <el-form ref="form" :model="form" label-width="120px">
                        ...
                        <el-col :span="7">
                            <el-form-item label="房屋名称" prop="houseName">
                                <el-input v-model="form.houseName" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                        <el-col :span="7">
                	...
                	<el-row :gutter="24">
                        <el-col :span="7">
                            <el-form-item label="房屋地址" prop="houseAddress">
                                <el-input v-model="form.houseAddress" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                        <el-col :span="7">
                            <el-form-item label="面积" prop="houseArea">
                                <el-input v-model="form.houseArea" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                        <el-col :span="7">
                            <el-form-item label="租金" prop="housePrice">
                                <el-input v-model="form.housePrice" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                	</el-row>
                	<el-row :gutter="24">
        ...
        <div class="list-panel">
            ...
            <div class="list-list">
                <el-table border style="width: 100%" :data="tableData" ref="multipleTable">
                        ...
                        <el-table-column prop="houseName" label="房屋名称"></el-table-column>
                        ...
                        <el-table-column prop="housePrice" label="租金"></el-table-column>
        ...
        <div class="popdialog-container">
            <el-dialog 
                ...
                <rent-house :checkrow="checkRow" @closechild="closechild"></rent-house>
            </el-dialog>
        </div>
    </div>
</template>
<script>
import rentHouse from "@/components/page/rent/house/rentHouseManager"
...
export default {
    ...
    methods:{
	    ...
	    del(){
	      ...
	      houseApi.deleteByIds(param).then((res)=>{
                if(res.code == "0"){
                  this.$message({
                    showClose: true,
                    message: '删除成功！',
