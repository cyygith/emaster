    ...
    <div id="itemlist-panel" class="itemlist-panel">
                	...
                	<el-row :gutter="24">
                        ...
                        <el-col :span="7">
                            <el-form-item label="上月电费" prop="lastElectric">
                                <el-input v-model="form.lastElectric" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                	</el-row>
                	<el-row :gutter="24">
                        <el-col :span="7">
                            <el-form-item label="本月电费" prop="currElectric">
                                <el-input v-model="form.currElectric" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                        <el-col :span="7">
                            <el-form-item label="水费支付方式  1-按吨支付  2-按人数支付" prop="waterPayType">
                                <el-input v-model="form.waterPayType" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                        <el-col :span="7">
                            <el-form-item label="租住人数" prop="rentNum">
                                <el-input v-model="form.rentNum" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                	</el-row>
                	<el-row :gutter="24">
                        <el-col :span="7">
                            <el-form-item label="上月水费" prop="lastWater">
                                <el-input v-model="form.lastWater" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                        <el-col :span="7">
                            <el-form-item label="本月水费" prop="currWater">
                                <el-input v-model="form.currWater" size="small"></el-input>
                            </el-form-item>
                        </el-col>	
                        <el-col :span="7">
        ...
        <div class="list-panel">
            ...
            <div class="list-list">
                <el-table border style="width: 100%" :data="tableData" ref="multipleTable">
                        ...
                        <el-table-column prop="lastElectric" label="上月电费"></el-table-column>
                        <el-table-column prop="currElectric" label="本月电费"></el-table-column>
                        <el-table-column prop="waterPayType" label="水费支付方式  1-按吨支付  2-按人数支付"></el-table-column>
                        <el-table-column prop="rentNum" label="租住人数"></el-table-column>
                        <el-table-column prop="lastWater" label="上月水费"></el-table-column>
                        <el-table-column prop="currWater" label="本月水费"></el-table-column>
                        <el-table-column prop="payType" label="租金支付方式 1-支付宝  2-微信  3-现金"></el-table-column>
        ...
        <div class="popdialog-container">
            <el-dialog 
                ...
                <rent-bill :checkrow="checkRow" @closechild="closechild"></rent-bill>
            </el-dialog>
        </div>
    </div>
</template>
<script>
import rentBill from "@/components/page/rent/bill/rentBillManager"
