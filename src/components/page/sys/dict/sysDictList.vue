<template>
    <div id="itemlist-panel" class="itemlist-panel">
                    ...
                    <el-row :gutter="24">
                        <el-col :span="7">
                            <el-form-item label="代码值" prop="codeValue">
                                <el-input v-model="form.codeValue" size="small"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="7">
        ...
        <div class="list-panel">
            ...
            <div class="list-list">
                <el-table border style="width: 100%" :data="tableData" ref="multipleTable">
                    ...
                    <el-table-column prop="codeValue" label="代码值"></el-table-column>
        ...
        <div class="popdialog-container">
            ...
            >
                <sys-dict :checkrow="checkRow" @closechild="closechild"></sys-dict>
            </el-dialog>
        </div>
    </div>
</template>
<script>
import sysDict from "@/components/page/sys/dict/sysDictManager";
